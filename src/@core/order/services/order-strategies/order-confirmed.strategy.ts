import { IOrderConfirmedStrategy } from '../../../application/contracts/order.strategy';
...
@Injectable()
export class OrderConfirmedStrategy
  implements
...
export const OrderConfirmedStrategyProvider = ProviderMaker.make(
  IOrderConfirmedStrategy,
  OrderConfirmedStrategy,
);
