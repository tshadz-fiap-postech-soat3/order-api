import { IOrderReadyToPickupStrategy } from '../../../application/contracts/order.strategy';
...
@Injectable()
export class OrderReadyToPickupStrategy
  implements
...
export const OrderReadyToPickupStrategyProvider = ProviderMaker.make(
  IOrderReadyToPickupStrategy,
  OrderReadyToPickupStrategy,
);
